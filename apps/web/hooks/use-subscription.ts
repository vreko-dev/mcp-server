...
> {
	return useResourceQuery(["subscription-data"], () => fetchSubscriptionData(), {
...
export function useUpgradeSubscription(): ReturnType<
	typeof useResourceMutation<{ success: boolean; message: string }, { newTier: string }, unknown>
> {
	const queryClient = useQueryClient();

	return useResourceMutation<{ success: boolean; message: string }, { newTier: string }, unknown>(
		async (input) => {
...
export function useCancelSubscription(): ReturnType<
	typeof useResourceMutation<{ success: boolean; message: string }, void, unknown>
> {
	const queryClient = useQueryClient();

	return useResourceMutation<{ success: boolean; message: string }, void, unknown>(
		async () => {
