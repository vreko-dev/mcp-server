...
const featureTabs: FeatureTab[] = [
	{
		...
		title: "AI Detection",
		description:
			"Real-time monitoring of AI coding assistants to prevent destructive changes",
		...
		highlights: [
			{
				...
				description:
					"Detects destructive AI refactoring patterns before they cause damage",
			},
			{
				icon: CheckCircleIcon,
	...
	},
	{
		...
		description:
			"Automatic version control that captures your code state before AI changes",
		icon: FileTextIcon,
		highlights: [
			{
				icon: CheckCircleIcon,
				...
				description:
					"Creates checkpoints every 5 minutes or before major AI operations",
			},
			{
				icon: CheckCircleIcon,
				title: "Lightning Fast",
				description:
					"Checkpoint creation in under 100ms with minimal performance impact",
			},
		],
	},
	{
		...
		description:
			"Restore your codebase to any previous checkpoint with a single click",
