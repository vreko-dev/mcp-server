			...
			<div className="container mx-auto px-4">
				<div className="text-center max-w-3xl mx-auto mb-20 space-y-6">
					<h2 className="text-3xl lg:text-5xl font-bold text-white">
						{social_proof.content.headline}
					</h2>
					<p className="text-lg text-[#A0A0A0]">{social_proof.content.label}</p>
				</div>

				{/* Testimonials */}
				{social_proof.content.testimonials &&
					social_proof.content.testimonials.length > 0 && (
						<div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto mb-20">
							{social_proof.content.testimonials.map(
								(testimonial: any, index: number) => (
									...
									>
										<div className="text-2xl text-[#333] absolute top-6 left-6 font-serif">
											"
										</div>
										<p className="text-lg text-white mb-6 relative z-10 pl-4">
											{testimonial.quote}
										</p>
				...
				<div className="text-center space-y-4">
					...
					<p className="text-xs text-[#555]">
						{social_proof.content.cta.subtext}
					</p>
				</div>
			</div>
		</section>
