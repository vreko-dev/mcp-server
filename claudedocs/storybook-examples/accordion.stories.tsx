	...
	render: () => (
		<Accordion type="single" collapsible className="w-[450px]">
			<AccordionItem value="item-1">
				...
				<AccordionContent>
					SnapBack is an automatic version control system that creates snapshots of your code every time you
					save, giving you the freedom to experiment without fear of losing your work.
				</AccordionContent>
			</AccordionItem>
			...
			<AccordionItem value="item-2">
				...
				<AccordionContent>
					SnapBack monitors your file changes and automatically creates snapshots based on intelligent
					policies. You can configure protection levels, file patterns, and cooldown periods to match your
					workflow.
				</AccordionContent>
			</AccordionItem>
			...
			<AccordionItem value="item-3">
				...
				<AccordionContent>
					Yes! You can browse your snapshot timeline and restore any previous version with a single click. All
					snapshots are stored securely and can be accessed through the VSCode extension or web dashboard.
				</AccordionContent>
			</AccordionItem>
		</Accordion>
	),
					...
					<div className="space-y-3 text-sm">
						<div>
							...
							<p className="text-muted-foreground">
								Install the VSCode extension from the marketplace, sign in with your account, and
								SnapBack will start protecting your files automatically.
							</p>
						</div>
						<div>
							<p className="font-medium">Is my code secure?</p>
							<p className="text-muted-foreground">
								Yes, all snapshots are encrypted at rest and in transit. We use industry-standard
								AES-256 encryption.
							</p>
						</div>
					</div>
				...
				<AccordionContent>
					<div className="space-y-3 text-sm">
						<div>
							...
							<p className="text-muted-foreground">
								By default, all code files in your workspace. You can configure file patterns and
								exclusions in the settings.
							</p>
						</div>
						<div>
							<p className="font-medium">How long are snapshots kept?</p>
							<p className="text-muted-foreground">
								Retention period depends on your plan: 7 days (Free), 30 days (Solo), 90 days (Team).
							</p>
						</div>
					</div>
				</AccordionContent>
	...
	render: () => (
		<Accordion type="single" collapsible className="w-[500px]">
			...
			<AccordionItem value="item-2" className="border-0 bg-muted/30 rounded-lg px-4 mb-2">
				<AccordionTrigger className="hover:no-underline">⚙️ Configuration</AccordionTrigger>
				<AccordionContent>
			...
			<AccordionItem value="item-3" className="border-0 bg-muted/30 rounded-lg px-4 mb-2">
				<AccordionTrigger className="hover:no-underline">📊 Analytics</AccordionTrigger>
				<AccordionContent>
				...
				<AccordionContent>
					<Accordion type="single" collapsible>
						<AccordionItem value="protection">
							<AccordionTrigger className="text-sm">Protection Policies</AccordionTrigger>
							<AccordionContent className="text-sm">
								Configure automatic protection rules, cooldown periods, and file patterns for this
								workspace.
							</AccordionContent>
						</AccordionItem>
						<AccordionItem value="notifications">
							...
							<AccordionContent className="text-sm">
								Choose when and how you receive notifications about snapshots and protection events.
							</AccordionContent>
						</AccordionItem>
					</Accordion>
				</AccordionContent>
			...
			<div className="bg-background p-8">
				<Accordion type="single" collapsible className="w-[450px]">
					<AccordionItem value="item-1">
						...
						<AccordionContent>
							The accordion component automatically adapts to dark mode using semantic color tokens.
						</AccordionContent>
					</AccordionItem>
					<AccordionItem value="item-2">
						<AccordionTrigger>Theme customization</AccordionTrigger>
						<AccordionContent>
							All colors are driven by CSS custom properties, making it easy to customize the appearance.
						</AccordionContent>
					</AccordionItem>
				</Accordion>
			</div>
