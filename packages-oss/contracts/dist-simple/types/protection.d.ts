...
export declare const ProtectionLevelMetadataSchema: z.ZodObject<
	...
	z.core.$strip
>;
export type ProtectionLevelMetadata = z.infer<
	typeof ProtectionLevelMetadataSchema
>;
/**
 * Protection level configurations with UI metadata
 */
export declare const PROTECTION_LEVELS: Record<
	ProtectionLevel,
...
export declare const ProtectionManagerOptionsSchema: z.ZodObject<
	...
	z.core.$strip
>;
export type ProtectionManagerOptions = z.infer<
	typeof ProtectionManagerOptionsSchema
>;
/**
