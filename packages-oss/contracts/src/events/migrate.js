 ...
 */
import { CoreTelemetryEvent, validateCoreTelemetryEvent, SaveAttemptSchema, SnapshotCreatedSchema, SessionFinalizedSchema, IssueCreatedSchema, IssueResolvedSchema, SessionRestoredSchema, PolicyChangedSchema } from "./core";
import { LegacyAllowedTelemetryEvent, LEGACY_TELEMETRY_EVENTS, validateLegacyTelemetryEvent } from "./index";
/**
...
export class TelemetryEventMapper {
    ...
    mapRiskDetected(event) {
        ...
        const issueCreatedEvent = {
            ...
            properties: {
                ...
                severity: event.properties.riskLevel, // Map risk level to severity
    ...
    mapWalkthroughStepCompleted(event) {
