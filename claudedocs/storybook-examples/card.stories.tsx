  ...
  render: () => (
    <Card className="w-[350px]">
      <CardHeader>
        ...
        <CardDescription>
          Automatic version control for your code changes.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <p className="text-sm">
          SnapBack automatically creates snapshots every time you save, giving
          you the freedom to experiment without fear of losing your work.
        </p>
      </CardContent>
...
export const Interactive: Story = {
  render: () => (
    <Card className="w-[350px] cursor-pointer transition-all hover:shadow-lg hover:border-primary/50">
      ...
      <CardContent>
        <p className="text-sm">
          Try hovering over this card to see the shadow and border effects.
        </p>
      </CardContent>
    </Card>
  ),
    ...
    <div className="dark">
      <div className="bg-background p-8">
        <Card className="w-[350px]">
          ...
          <CardContent>
            <p className="text-sm text-muted-foreground">
              The card component uses semantic color tokens that work in both
