...
const TimelineEntryComponent = ({
  ...
  return (
    <motion.div
      ...
      aria-label={`${entry.description} at ${entry.time}${entry.canRestore ? ', click to restore' : ''}`}
    >
      {/* Dot */}
      <div
        className={`
    ...
    {visible && (
      <motion.div
        ...
        className="absolute top-3 right-3 flex items-center gap-2 px-3 py-1.5
                   bg-purple-500/15 border border-purple-500/30 rounded-md"
      >
        <span className="text-xs text-purple-400">🤖 AI editing</span>
    ...
    {visible && (
      <motion.div
        ...
        className="absolute bottom-0 left-0 right-0 p-3
                   ...
                   font-mono text-[13px] text-red-400"
      >
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-3 bg-zinc-900 border-b border-zinc-800">
          ...
          <div className="flex items-center gap-2">
            <span className="text-[13px] font-medium text-zinc-500 font-mono">
              config.ts
            </span>
        ...
        {/* Content */}
        <div className="grid grid-cols-1 md:grid-cols-[1fr_280px] min-h-[400px]">
          {/* Editor Panel */}
          <div className="relative bg-[#0d1117] border-r border-zinc-800 overflow-hidden">
            <div className="p-5 h-full overflow-auto scrollbar-thin scrollbar-thumb-zinc-700 scrollbar-track-transparent">
          ...
          <div className="bg-zinc-950 flex flex-col">
            <div className="px-4 py-3 text-[13px] font-semibold text-zinc-500 border-b border-zinc-800 flex items-center gap-2">
              <span>🕐</span>
              <span>SnapBack Timeline</span>
            </div>
        ...
        <div className="flex items-center justify-between px-4 py-2.5 bg-zinc-900 border-t border-zinc-800">
          <div className="flex items-center gap-2.5">
            <div
              className={`w-2 h-2 rounded-full shadow-lg ${statusIndicatorClass}`}
            />
            <span className={`text-xs font-medium transition-colors ${statusTextClass}`}>
              {statusText}
            </span>
          </div>
          <button
