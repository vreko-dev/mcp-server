...
export function QueueTasksPreview({ className }: QueueTasksPreviewProps) {
	...
	return (
		<div
			className={cn(
				"rounded-lg border border-snapback-border bg-snapback-bg-secondary p-6",
				className,
			)}
		>
			<div className="space-y-4">
				<div>
					<h3 className="text-lg font-semibold text-snapback-text-primary mb-1">
					...
					{tasks.map((task, index) => (
						...
						>
							...
							<div className="flex-1">
								...
								<p className="text-xs text-snapback-text-secondary">
									{task.description}
								</p>
							</div>
