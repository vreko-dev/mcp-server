 ...
 */
export async function checkDependencies(input: DependencyCheckInput): Promise<DependencyCheckResult> {
	...
	const depTypes: Array<keyof PackageJson> = ["dependencies", "devDependencies", "peerDependencies"];
 ...
 */
function checkVulnerabilities(dependencies: Record<string, string>): VulnerabilityInfo[] {
 ...
 */
function detectMajorVersionChanges(updates: DependencyChange[]): string[] {
