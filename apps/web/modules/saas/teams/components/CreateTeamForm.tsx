	...
	const onSubmit = async (values: CreateTeamFormValues) => {
		...
		toast.promise(
			(async () => {
				...
				if (apiError) {
					throw new Error(
						apiError.message || "Failed to create team",
					);
				}
		...
		<Dialog open={open} onOpenChange={onOpenChange}>
			<DialogContent className="max-w-2xl">
				<DialogHeader>
					...
					<DialogDescription>
						Teams allow you to organize members within your
						organization
					</DialogDescription>
				</DialogHeader>
				...
				<Form {...form}>
					...
					>
						...
						<FormField
							...
							render={({ field }) => (
								<FormItem>
									...
									<FormDescription>
										A unique name for your team within this
										organization
									</FormDescription>
									<FormMessage />
								</FormItem>
						...
						<FormItem>
							...
							<FormDescription>
								Select members to add to this team (optional - you
