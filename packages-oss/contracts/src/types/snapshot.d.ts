...
export declare const RichSnapshotSchema: z.ZodObject<{
    ...
    fileContents: z.ZodOptional<z.ZodRecord<z.ZodString, z.ZodString>>;
    name: z.ZodString;
    fileStates: z.ZodOptional<z.ZodArray<z.ZodObject<{
        path: z.ZodString;
        content: z.ZodString;
        hash: z.ZodString;
    }, z.core.$strip>>>;
...
export declare const SnapshotManagerConfigSchema: z.ZodObject<{
    ...
    namingStrategy: z.ZodDefault<z.ZodEnum<{
        timestamp: "timestamp";
        custom: "custom";
        git: "git";
        semantic: "semantic";
...
export interface SnapshotStorage {
    ...
    restore(id: string, targetPath: string, options?: {
        files?: string[];
        dryRun?: boolean;
 ...
 */
export declare function createSnapshotStorage(basePath: string): Promise<SnapshotStorage>;
