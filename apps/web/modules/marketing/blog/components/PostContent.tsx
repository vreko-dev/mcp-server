...
const components: MDXComponents = {
	h1: (props) => <h1 className="text-4xl font-bold mt-12 mb-8 text-white" {...props} />,
	h2: (props) => <h2 className="text-3xl font-bold mt-12 mb-8 text-white" {...props} />,
	h3: (props) => <h3 className="text-2xl font-bold mt-10 mb-6 text-white" {...props} />,
	h4: (props) => <h4 className="text-xl font-bold mt-8 mb-4 text-white" {...props} />,
	...
	pre: (props) => <pre className="mb-6 p-4 bg-slate-900 rounded-lg overflow-x-auto" {...props} />,
	img: (props) => <img className="rounded-lg my-6 mx-auto max-w-full h-auto" loading="lazy" {...props} />,
};
