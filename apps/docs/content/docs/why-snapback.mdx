...
That's the entire difference. Git tracks what you commit. SnapBack tracks what AI does between commits.
...
[Learn about performance ↗](/performance)
</callout>
...
[Integration guides ↗](/integrations/copilot)
</callout>
...
- [Quick Start Guide →](/quick-start) – Install and create your first snapshot
- [Your First Restore →](/getting-started/first-restore) – Walk through a recovery scenario
- [How It Works →](/ai-detection) – Understand AI detection
