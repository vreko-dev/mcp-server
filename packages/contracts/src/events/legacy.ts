/**
 * Legacy Telemetry Events Schema
 *
 * This file defines the schema for all legacy telemetry events with strict typing
 * to ensure compile-time validation and runtime schema checking.
 * These events will be mapped to the new core events.
 */
