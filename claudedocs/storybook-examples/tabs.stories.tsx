      ...
      <TabsContent value="snapshots">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Your automatically created version snapshots
            </CardDescription>
          </CardHeader>
          <CardContent>
      ...
      <TabsContent value="protected">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Files currently under automatic protection
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-2">
...
export const FullWidth: Story = {
  ...
  return snapshot;
        ...
        <TabsContent value="console" className="min-h-[200px] rounded-md border bg-black p-4 font-mono text-sm text-green-400">
      ...
      <div className="bg-background p-8">
        <Tabs defaultValue="features" className="w-[400px]">
          ...
          <TabsContent value="features">
            <p className="text-sm text-muted-foreground">
              Tabs automatically adapt to dark mode theme.
            </p>
          </TabsContent>
  ...
  render: () => (
    <Tabs defaultValue="active" className="w-[400px]">
      ...
      <TabsContent value="locked">
        <p className="text-sm text-muted-foreground">
          This content requires upgrading your plan.
        </p>
      </TabsContent>
    </Tabs>
  ),
